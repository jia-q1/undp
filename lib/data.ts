...
export const reportData = {
  hero: {
    ...
    subheadline: "The Crisis Bureau's 2025 report on turning crisis signals into action — through rapid expert deployment, pre-approved authorities, and a 15,000-strong roster of vetted talent.",
    metrics: [
      { value: 2585, label: "Deployments", animated: true },
    ...
    crises: [
      {
        ...
        level: "L3",
        experts: 5,
        roles: ["Information Management & Recovery Planning", "Recovery Planning & Coordination", "Early Recovery Advisor", "PDNA/DALA Coordination Specialist", "SURGE Team Leader"],
        description: "5 SURGE advisors deployed after the October hurricane — the highest-volume crisis response of 2025",
      },
      {
        id: "syria",
        name: "Syria",
        ...
        description: "17 advisors/experts deployed following the ceasefire (8 SURGE/DA, 6 ExpRes, 3 TAs)",
      },
      {
        id: "myanmar",
        name: "Myanmar",
        ...
        description: "4 advisors/experts (2 SURGE, 2 ExpRes) for earthquake and conflict response",
      },
      {
        id: "drc",
        name: "DRC",
        ...
        description: "1 SURGE Advisor and 2 ExpRes experts deployed following conflict escalation",
      },
      {
        id: "lebanon",
        name: "Lebanon",
        ...
        description: "Durable Solutions Advisor deployed to support ongoing response and recovery planning",
      },
      {
        id: "afghanistan",
        name: "Afghanistan",
        ...
        description: "2 SURGE Advisors plus 1 ExpRes Shelter Expert deployed after the Eastern Afghanistan earthquake",
      },
      {
        id: "pakistan",
        name: "Pakistan",
        ...
        description: "1 SURGE Advisor deployed to support Early Recovery coordination following widespread flooding",
      },
      {
        id: "jamaica",
        name: "Jamaica",
        ...
        description: "5 SURGE Advisors deployed after the October hurricane",
      },
      {
        id: "srilanka",
        name: "Sri Lanka",
        level: "L1",
        experts: 5,
        roles: ["Early Recovery Cluster Coordinator", "Early Recovery Cluster Coordinator", "Early Recovery Cluster Coordinator", "Debris Management", "Structural/Housing Engineering"],
        description: "3 SURGE Advisors plus 2 ExpRes experts deployed following the March earthquakes",
      },
      {
        id: "burundi",
        name: "Burundi",
        level: "—",
        experts: 2,
        roles: ["Livelihoods/Resilience Advisor", "Nexus Advisor"],
        description: "No formal declaration — 1 SURGE Advisor and 1 ExpRes Advisor deployed for response and recovery planning",
      },
      {
        id: "madagascar",
        name: "Madagascar",
        ...
        description: "No formal declaration — 4 SURGE Advisors deployed in November following severe flooding",
      },
      {
        id: "burkinafaso",
        name: "Burkina Faso",
        ...
        experts: 3,
        roles: ["Crisis Communications", "Crisis Coordination", "Stress Counselling"],
        description: "No formal declaration — 1 SURGE Advisor and 2 ExpRes specialists deployed following escalation of conflict",
      },
    ],
  },
